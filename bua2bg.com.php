...
<li><a href="http://cherry67.netne.net/afsana/loginbgn.php">&#2476;&#2497;&#2527;&#2494; &#2489;&#2495;&#2488;&#2503;&#2476; &#2482;&#2455;&#2439;&#2472; </a></li>
...
<div class="jumbotron text-center"> 
  <h1>বুয়া.COM</h1>  
  <p>আপনার বাসার জন্য নির্বাচন করুন বুয়া </p> 
...
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-8">
      <h1>স্বাগতম  বুয়া .com</h1><br>
      <h4>বর্তমান ব্যস্ত সময়ে অনেকেই তাদের ঘরের কাজ সঠিক সময়ে করে উঠতে পারে না। আপনার জীবনকে আরো সহজ করে তোলার জন্য এখান থেকে আপনি নির্বাচন করুন আপনার প্রয়োজন মত বুয়া।এখানে সকল  বুয়া বিশ্বস্ত,আপনি এখান থেকে বুয়া নির্বাচন করে আপনার জীবনকে আরো সহজ করে তুলুন।  </h4><br>
      <p>বুয়া .com আপনাকে উপযুক্ত বুয়া খুঁজে দিয়ে আপনার দৈনন্দিন জীবনকে আরো সহজ করে তুলবে। নির্ভরযোগ্য ও পারধর্শী বুয়া পেয়ে যান এবং বিশ্রাম নিন। অতএব নিজেদের ঝাডু ও স্পন্জ নিচে রেখে দিন আর বুয়া কে দায়িত্ব দিন। 

</p>
      
    </div>
    <div class="col-sm-4">
	<button class="button button1"><a class="a w" href="http://cherry67.netne.net/afsana/bua2.com.php">ENGLISH</a></button>
...
<div class="row">
	...
	<a href="http://cherry67.netne.net/afsana/criteriabg.php" class="ball yellowball">
    <div class="menuText">
       বুয়া ? 
    </div>
  </a>
...
<br>
<div id="menuBall4" class="menuBall">
	<a href="http://cherry67.netne.net/afsana/selectba.php" class="ball yellowball">
    <div class="menuText">
        কাজ ?
    </div>
  </a>
...
<br>
<br>
  <h2 class="text-center">নীতিমালা</h2>
  <ul style="list-style-type:square">
  <li>এখানে দুই ধরনের রেজিস্ট্রেশন আছে। একটি হচ্ছে যারা কাজ খুজ্ছে অর্থাৎ  যারা বুয়া হিসেবে কাজ করতে ইচ্ছুক এবং আরেকটি হচ্ছে  তাদের জন্য যারা বুয়া খুজছে। </li>
  <li>প্রত্যেক ক্ষেত্রেই রেজিস্ট্রেশন করতে হবে। </li>
  <li>যারা বুয়া খুজ্ছেন তারা রেজিস্ট্রেশন ছাড়া বুয়ার পুরো তথ্য পাবেন না। </li>
  <li>রেজিস্ট্রেশন ফ্রি তে করা যাবে। </li>
  <li>বুয়া.com কোনো অপ্রত্যাশিত ঘটনার জন্য দায়ী থাকবে না। </li>
</ul>
</div> 
