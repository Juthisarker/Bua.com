    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="http://cherry67.netne.net/afsana/loginen.php">LOGIN AS USER</a></li>
          <li><a href="http://cherry67.netne.net/afsana/new 1.php">LOGIN AS MAID</a></li>
...
<div class="jumbotron text-center">
  <h1>Bua.COM</h1> 
  <p>We ensure the best maid for your home</p> 
...
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-8">
      <h1>About MAID.COM</h1><br>
      <h4>Present time every person is very busy so they are not able to do all household chores in time. They want to finish their house work very easily by getting help from their maid servant. But they can not find suitable and trusted house maid . So Bua.Com is trying to resolve your problem and find for you a trusted, verified and active maid</h4><br>
      <p>Bua.com makes you daily tasks easier by finding you the best maid for yourself.Get eligible maids as desired for your homes and just go and relax.So put down yor brooms and sponges and let your maids take care of the mess.

</p>
      
    </div>
    <div class="col-sm-4">
	<button class="button button1"><a class="a w" href="http://cherry67.netne.net/afsana/bua2bg.com.php">&#2476;&#2494;&#2434;&#2482;&#2494; <a></button>
      <img src="bua.jpeg"  height="300" width="300">
    </div>
<div>
<!-- hitwebcounter Code START -->
<a href="http://www.hitwebcounter.com" target="_blank">
<img src="http://hitwebcounter.com/counter/counter.php?page=6614455&style=0001&nbdigits=3&type=ip&initCount=0" title="install tracking codes" Alt="install tracking codes"   border="0" >
</a>                                        <br/>
...
<div id="services" class="container-fluid1 text-center">
<br><br><br>
<br><br><br>
<div class="row">
    <div class="col-sm-4">
	...
	<a href="http://cherry67.netne.net/afsana/criteriaenglish.php" class="ball yellowball">
    <div class="menuText">
       BUA
    </div>
  </a>
...
<br>
<div id="menuBall4" class="menuBall">
	<a href="http://cherry67.netne.net/afsana/select.php" class="ball yellowball">
    <div class="menuText">
        WORK
    </div>
  </a>
...
<br>
  ...
  <li>Two fields of registration are available.One for work those who are interested to work as maids and the other is Bua where users can find maids for their homes.</li>
  <li>Each field of registration must be filled correctly </li>
  <li>Users cannot view personal info of maids until they get register.</li>
  <li>Registration is Free </li>
  <li>Bua.Com will not be responsible for any occurance</li>
</ul>
</div>
...
<footer class="container-fluid text-center">
  <a href="#myPage" title="To Top">
    <span class="glyphicon glyphicon-menu-up logo-small"></span>
  </a>
  <p>Copyright Bua.Com</p>		
</footer>
