  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="http://cherry67.netne.net/afsana/buabg.php#about">হোম</a></li> 
        <li><a href="http://cherry67.netne.net/afsana/bua2.com.php#services">সেবা</a></li> 
        <li><a href="http://cherry67.netne.net/afsana/loginbg.php">লগইন</a></li> 
        
        <li><a href="http://cherry67.netne.net/afsana/bua2.com.php#contact">নীতিমালা</a></li> 
      </ul>
    </div>
  </div>
</nav>
...
<br><br><br>
<br><br><br>  
   <form action="loginbg.php" name="login-form" class="login-form"  method="post">
		...
		<div class="content">
		<input name="name" type="text" class="input username" placeholder= " ইউজার নাম " >
		<div class="user-icon"></div>
		<input name="pass" type="password" class="input password" placeholder= "পাসওয়ার্ড" > 
		<div class="pass-icon"></div>		
		</div>

		<div class="footer">
		<input type="submit" name="login" value="লগইন" class="button" > 
...
{  
    ...
    $check_user="select * from userinfo1 WHERE username='$user_name'AND password='$user_pass'";  
  
    $run=mysqli_query($dbcon,$check_user);  
  
    if(mysqli_num_rows($run))  
    {  
        echo "<script>window.open('welcomebg.php','_self')</script>";  
