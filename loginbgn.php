...
<br><br><br>
<br><br><br>  
   <form action="loginbgn.php" name="login-form" class="login-form"  method="post">
...
{  
	...
	if($type==$a)
	{
//echo "full time e dhukse";
    $check_user1="select * from buafull WHERE username='$user_name'AND password='$user_pass'";  
  
    $run=mysqli_query($dbcon,$check_user1);  
	...
	{
          //echo "part time e dhukse";
    $check_user="select * from buapart WHERE username='$user_name'AND password='$user_pass'";  
    ...
    {  
      ...
      echo "<script>window.open('loginbgn.php','_self')</script>";
    }  
