  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="http://cherry67.netne.net/afsana/logout.php">LOG OUT</a></li>
...

{
	...
	$sql="SELECT name,area,age,salary,contact,ref,image_url FROM  buafull WHERE  area= '" . $area ."' and age BETWEEN '" . $Age1 ."' AND '" . $Age2 ."' ";
...
<th>Photo</th>
   ...
   echo "<td><img src='upimg/".$emp['image_url']."' width='150' height='150'></td>";
	...
	$sql1="SELECT name,age,area,cook,clean,wash,contact,ref,image_url   FROM  buapart WHERE  area= '" .$area."' AND age BETWEEN '" . $Age1 ."' AND '" . $Age2 ."' ";
 ...
 <th>age</th>
 <th>area</th>
<th> cooking rate(BDT)</th> 
<th> cleaning rate(BDT)</th> 
<th>washing rate(BDT)</th>
<th>contact</th>
<th>reference</th>
<th>Photo</th>
